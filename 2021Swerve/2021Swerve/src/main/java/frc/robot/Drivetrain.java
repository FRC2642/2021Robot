...
public class Drivetrain {
  ...
  private final SwerveModule m_frontLeft = new SwerveModule(frontLeftDriveMotor, frontLeftAngleMotor);
  private final SwerveModule m_frontRight = new SwerveModule(frontRightDriveMotor, frontRightAngleMotor);
  private final SwerveModule m_backLeft = new SwerveModule(backLeftDriveMotor, backLeftAngleMotor);
  private final SwerveModule m_backRight = new SwerveModule(backRightDriveMotor, backRightAngleMotor);
