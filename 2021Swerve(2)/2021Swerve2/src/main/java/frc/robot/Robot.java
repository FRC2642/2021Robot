...
public class Robot extends TimedRobot {
  ...
  private SwerveModule backRight = new SwerveModule (0, 1);
  private SwerveModule backLeft = new SwerveModule (2, 3);
  private SwerveModule frontRight = new SwerveModule (4, 5);
  private SwerveModule frontLeft = new SwerveModule (6, 7);

  private Drivetrain swerveDrive = new SwerveDrive (backRight, backLeft, frontRight, frontLeft);
